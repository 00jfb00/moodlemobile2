...
export interface AddonModQuizAccessRuleHandler extends CoreDelegateHandler {
    ...
    /**
     * Function called when preflight form is closed.
     * Should delete from the preflight data all the data that should be resetted for the next form shown.
     *
     * @param {any} preflightData Preflight data gathered.
     */
    cleanPreflight?(preflightData: any): void;
...
export class AddonModQuizAccessRuleDelegate extends CoreDelegate {
    ...
    constructor(injector: Injector, protected utils: CoreUtilsProvider) {
        super('AddonModQuizAccessRulesDelegate', injector, true);
    }
